...
class TechOtherRenderer : Renderer<TechOtherModel, TechOtherViewHolder>() {
    ...
    override fun bindView(model: TechOtherModel, holder: TechOtherViewHolder) {
        with(holder) {
            passengerTitle.text = model.passengerTitle ?: "N/A"
            ...
            passengerABTitle.text = model.passengerABTitle ?: "N/A"
            ...
            hitchTitle.text = model.hitchTitle ?: "N/A"
...
data class TechOtherModel(
        val TYPE: Int = constants.TYPE_TECH_OTHER,
