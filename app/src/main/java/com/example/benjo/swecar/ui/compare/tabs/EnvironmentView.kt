...
import com.example.benjo.swecar.ui.compare.data.model.EnvironmentCompareModel
...
import com.example.benjo.swecar.utils.Constants.Companion.RENDERER_TYPE_ENVIRONMENT
...
class RendererEnvironmentView : Renderer<EnvironmentCompareModel, EnvironmentViewHolder>() {
    ...
    override fun bindView(model: EnvironmentCompareModel, holder: EnvironmentViewHolder) = with(holder) {
